...
function MarcasLlantas(): JSX.Element {
  const columns = [
  ...
  const readPath = "/llantas/getAllMarcasLlantas";
  const pushPath = "/llantas/postMarcasLlantas";
  ...
  return (
    <>
      {authorizedToRead && (
        <DataTableWithModal
          dialogTitle="Añadir nueva marca de llantas."
          title="Marcas de llantas"
          dataTableData={{ rows: allCC, columns: columns }} // Pass the state to the prop.
          description="Información General de las marcas de llantas"
