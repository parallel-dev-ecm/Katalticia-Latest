...
function MedidasLlantas(): JSX.Element {
  const columns = [
  ...
  const readPath = "/llantas/getAllMedidasLlantas";
  const pushPath = "/llantas/postMedidasLlantas";
  ...
  return (
    <>
      {authorizedToRead && (
        <DataTableWithModal
          dialogTitle="Añadir nuevas medidas de llantas."
          title="Medidas de llantas"
          dataTableData={{ rows: allCC, columns: columns }} // Pass the state to the prop.
          description="Información General de las medidas de llantas"
